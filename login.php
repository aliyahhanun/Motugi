...
<body>       
    <div class="container-fuild" style="background-image: url(assets/img/slide/POSE.jpg);">
        ...
        <form action="login.php" method="post" style="z-index: 4; color: white; position: absolute; margin-left: 390px; margin-top: 100px;">
            ...
            <div class="container" style="z-index: 5;">
                ...
                <label style=""><a href="signup.php">Forgot Password?</a></label>

                <label>&nbsp;</label>
                <button type="submit" name="Login" value="Login">Login</button>
                
                <label style="">Don't Have an Acoount?<a href="signUp.php"> Register</a></label>
            </div>
        </form>
